...
**1** Download the data file above and place it in a working directory.  Set your working directory.  Read in the data file and place it in a data frame object named "data1".  Using mean(), calculate the mean of the variable "length" and report the results in a comment to 2 decimal points accuracy.  Show your R code.
