...
**1** Create a vector named my_var1 that contains the following 6 integers: 3, 6, 12, 7, 5, 0.1. Create a Second vector called my_var2 that contains the following 2 integers: 2, 3.  Evaluate the expression my_var1 + my_var 2.  Explain the output in terms of R mechanics in your own words.
