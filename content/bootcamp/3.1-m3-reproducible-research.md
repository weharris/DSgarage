...
Analysing data using R can generate complex scripts that might make sense to you while you're actively working on them, but they won't to future you or collaborators. This bootcamp module offers guidance to make your code reproducible, both for yourself and others. Following a set of “rules” will improve your R workflow and reduce errors.
